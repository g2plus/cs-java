...
import top.arhi.nacos.config.FeignLogConfig;
...
@FeignClient(value = "nacos-provider",configuration = FeignLogConfig.class,fallback = GoodsFeignClientFallback.class)
