package top.arhi.wxpush.controller;
...
public class WechatController {
    ...
    public String receiveMsg(@RequestParam(required = false) String echostr, HttpServletRequest request, HttpServletResponse response) {
