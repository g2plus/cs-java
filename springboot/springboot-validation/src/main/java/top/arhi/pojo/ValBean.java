...
public class ValBean {
    ...
    /**
     * @Validated与@Valid注解区别（都是用在javaBean对象上） ①，所属的包不同
     ...
     * @Validated在@Valid之上提供了分组功能和验证排序功能 Bean Validation 中内置的 constraint
     * @Null 被注释的元素必须为 null
    ...
    @Pattern(regexp = "^\\S*(?=\\S{6,})(?=\\S*\\d)(?=\\S*[A-Z])(?=\\S*[a-z])(?=\\S*[!@#$%^&*? ])\\S*$", message = "密码强度校验，最少6位，包括至少1个大写字母，1个小写字母，1个数字，1个特殊字符")
