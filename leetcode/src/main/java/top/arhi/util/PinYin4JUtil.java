...
public class PinYin4JUtil {
     ...
     * @return
     */
    public static String[] stringToPinyin(String src, boolean isPolyphone, String separator) throws BadHanyuPinyinOutputFormatCombination {
        // 判断字符串是否为空
     ...
     * @return
     */
    public static String charToPinyin(char src, boolean isPolyphone, String separator) throws BadHanyuPinyinOutputFormatCombination {
        // 创建汉语拼音处理类
    ...
    public static String hanziToPinyin(String hanzi, String separator) {
        ...
        try {
            ...
            // TODO.md Auto-generated catch block
            e.printStackTrace();
        }
        return pinyingStr;
    }
    ...
    /**
     * 将汉字的第一个拼音字符进行拼接成一个字符串
     *
     * @param chars
     * @return
     */
    public static String getHeadCharStr(String[] chars) {
