...
public abstract class Calculator {
    ...
    public abstract List<ContractPeriod> contractPeriods(Date startDate, Date stopDate, Integer gap, BigDecimal bigDecimal);

    public abstract ContractPeriod calculate(LocalDateTime periodStartDateTime, LocalDateTime periodEndDateTime, int billCode);


    public abstract ContractPeriod strategy(ContractPeriod contractPeriod, BigDecimal bigDecimal, int gap);
